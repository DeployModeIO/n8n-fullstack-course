...
export default async function DashboardPage() {
  ...
  const userName = session.email?.split('@')[0] || 'Student';
    ...
    <div className="mx-auto max-w-6xl px-4 py-12">
      <div className="mb-10">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Pick up where you left off and keep moving toward mastering N8N.
        </p>
      </div>
      ...
      <div className="mb-10 grid gap-4 sm:grid-cols-3">
        ...
        <div className="flex items-center gap-4 rounded-2xl p-5 backdrop-blur-xl bg-white/70 border border-gray-200/50 shadow-lg dark:bg-white/10 dark:border-white/15 dark:shadow-none">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">Minutes of content</p>
          </div>
        </div>
        <div className="flex items-center gap-4 rounded-2xl p-5 backdrop-blur-xl bg-white/70 border border-gray-200/50 shadow-lg dark:bg-white/10 dark:border-white/15 dark:shadow-none">
        ...
        <div className="mb-10 rounded-2xl p-6 backdrop-blur-xl bg-white/70 border border-gray-200/50 dark:bg-white/10 dark:border-white/15">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Pass with 70% to get your verifiable certificate.
              </p>
            </div>
            <Link
              href="/final-exam"
      ...
      <h2 className="mb-6 text-xl font-bold text-gray-900 dark:text-white">Course Modules</h2>
        ...
        {moduleProgress.map((mod) => (
          ...
          >
            ...
            <p className="mb-4 text-sm text-gray-500 dark:text-gray-500">
              {mod.completed}/{mod.lessons.length} completed
            </p>
